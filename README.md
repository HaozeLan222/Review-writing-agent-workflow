...
**A bilingual Agent workflow for evidence-grounded literature review drafting**
...
This repository provides a reusable Agent workflow for drafting evidence-grounded literature reviews from a user-provided paper set.
...
- **Chinese review drafting**: optimized for generating Chinese literature review drafts.
...
Then open this repository in Cursor, Claude Code, Codex CLI, or another Agent environment, and send:
